 ...
 *  <stdio.h>"
 */
/* TODO: handle all instances of constant long-double number (L)
	...
	case SPECIFIER_GROUP:
	  ...
	  switch (format[index + 1])
	    ...
	    case QUALIFIER_DOT: /* Collating symbol */
	      /*
	       * TODO: This will be easier to implement when multibyte
 ...
 * TrioReadGroup
 *
 * TODO: characterclass does not work with multibyte characters
 */
TRIO_PRIVATE BOOLEAN_T
TrioReadGroup
