...
function make_distribution(seq_len, motif) {
  ...
  if (motif["sea_site_distr"]) {
    ...
    var smooth_width = Math.min(20, motif["sea_site_distr"].length);
    var graph = new CentrimoGraph(rset, triangular_weights(smooth_width), null, null, null, null, data["align"], motif["len"]);
