...
XmlMotifParser.prototype._meme_motif = function (motif_index, motif_node, symbol_ids) {
  "use strict";
  // read the name
...
XmlMotifParser.prototype.process_meme_doc = function (doc) {
  ...
  for (i = 0; i < motifs.length; i++) {
    this._meme_motif(i+1, motifs[i], symbol_ids);
  }
};
...
XmlMotifParser.prototype._dreme_motif = function (motif_index, motif_node, alph_ids) {
  "use strict";
  var i;
  // read the id
...
XmlMotifParser.prototype._streme_motif = function (motif_index, motif_node, alph_ids) {
  "use strict";
  var i;
  // read the id
...
XmlMotifParser.prototype.process_dreme_doc = function (doc) {
  ...
  for (i = 0; i < motifs.length; i++) {
    this._dreme_motif(i+1, motifs[i], alphabet_ids);
  }
};
...
XmlMotifParser.prototype.process_streme_doc = function (doc) {
  ...
  for (i = 0; i < motifs.length; i++) {
    this._streme_motif(i+1, motifs[i], alphabet_ids);
  }
};
...
MotifParser.prototype.process_blob = function (blob, offset, chunk_size) {
  ...
  if (offset === 0 && typeof this.handler.begin == "function")
    this.handler.begin(blob.size, blob.name);
